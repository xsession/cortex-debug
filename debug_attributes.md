...
| memoryAddressUnitBytes | number | Both | Number of bytes represented by one target memory address step. Use 1 for byte-addressed MCUs such as ARM and AVR, and 2 for 16-bit word-addressed MCUs such as TI C2000 C28x and Microchip dsPIC/PIC24. |
